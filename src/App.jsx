...
export default function App() {
    ...
    const [projects, setProjects] = useState([
        {
            title: "Secure Django Authentication",
            description: "A secure Django app showcasing full authentication flow—including user registration, login, password change, and admin access—powered by PostgreSQL and environment-based configuration for secure settings management.",
            image: "https://placehold.co/600x400/1e1e1e/f94f28?text=Project+1",
            tags: ["Python", "Django", "Security"],
            link: "https://github.com/Abhijith-P-N/Login_using_DJANGO.git",
            isGenerating: false
        },
        {
            title: "Agronomy - IoT for Agriculture",
            description: "Agronomy is a web app that helps farmers monitor soil health and crop growth using IoT sensor data. It includes real-time dashboards, data alerts, and analytics built with Python, React, and MQTT.",
            image: "https://placehold.co/600x400/1e1e1e/f94f28?text=Project+2",
            tags: ["HTML", "CSS", "Frontend"],
            link: "https://github.com/Abhijith-P-N/Agronomy.git",
            isGenerating: false
        },
        {
    ...
    const SocialIcons = () => (
        <div className="flex justify-center md:justify-start gap-6 mt-8">
            <a href="https://github.com/Abhijith-P-N" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div className="relative z-10">
                            ...
                            <div className="relative w-48 h-48 md:w-64 md:h-64 flex-shrink-0">
                                ...
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        e.target.src = "https://placehold.co/320x320/1e1e1e/E0E0E0?text=Error";
                                    }}
                                />
                            </div>
                                ...
                                <div key={index} className="card rounded-lg overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300 flex flex-col">
                                    <div className="overflow-hidden relative">
                                        ...
                                        <div className="absolute inset-0 bg-black bg-opacity-60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                             <a href={project.link || "#"} target="_blank" rel="noopener noreferrer" className="accent-bg text-white font-semibold py-2 px-5 rounded-md">View Project</a>
                                        </div>
                                    </div>
                ...
                <footer className="py-8 border-t border-gray-800 mt-20">
                    <div className="container mx-auto px-6 text-center text-gray-500">
                        <p>&copy; {new Date().getFullYear()} Abhijith PN. All rights reserved.</p>
                    </div>
                </footer>
            </div>
        </div>
